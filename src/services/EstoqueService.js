...
class PedidoService {
    ...
    async cadastrarEstoque(dados) {
        ...
        if(!id_produtos || !localizacao_fisica || !quantidade) {
            throw {
                status: 400,
                mensagem: "id produto, localizacao fisica e quantidade são obrigatórios"
            }
        }
        ...
        if(typeof id_produtos != "number" || id_produtos <= 0) {
            throw {
                status: 400,
                mensagem: "id produtos deve ser um número positivo"
            }
        }
        ...
        if(typeof id_mov_entrada != "number" || id_mov_entrada <= 0) {
            throw {
                status: 400,
                mensagem: "id mov entrada deve ser um número positivo"
            }
        }
        ...
        if(typeof id_mov_saida != "number" || id_mov_saida <= 0) {
            throw {
                status: 400,
                mensagem: "id mov saida deve ser um número positivo"
            }
        }
    ...
    async atualizarEstoque(id, dados) {
        ...
        if(id_produtos != undefined) {
            if(typeof id_produtos != "number" || id_produtos <= 0) {
                throw {
                    status: 400,
                    mensagem: "O id produtos deve ser um número positivo"
                }
            }
        ...
        if(id_mov_entrada != undefined) {
            if(typeof id_mov_entrada != "number" || id_mov_entrada <= 0) {
                throw {
                    status: 400,
                    mensagem: "O id mov entrada deve ser um número positivo"
                }
            }
        ...
        if(id_mov_saida != undefined) {
            if(typeof id_mov_saida != "number" || id_mov_saida <= 0) {
                throw {
                    status: 400,
                    mensagem: "O id mov saida deve ser um número positivo"
                }
            }
